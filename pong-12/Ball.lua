--[[
	...
	Represents a ball which will bounce back and forth between paddles and walls until it passes a left or right boundary of the screen, scoring a point for the oppenent.
...
--[[
	Expects a paddle as an argument and returns true or false, depending on weather their rectangles overlap.
]]
...
--[[
	Places the ball in the middle of the screen, with an initial random velocity on both axis.
]]
function Ball:reset()
